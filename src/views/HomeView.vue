<template>
  <div
    class="min-h-screen bg-slate-900 relative flex items-center justify-center py-12 px-4"
  >
      ...
      <section class="max-w-4xl mx-auto mb-16">
        <div class="bg-white rounded-lg shadow-lg p-8">
          <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <!-- About Me Text -->
            <div class="flex-1">
              <h1 class="text-4xl font-bold text-grey-800 mb-4">Zoiye</h1>
              <p class="text-gray-600 text-lg">Hi my name is </p>
            </div>
          </div>
        </div>
      </section>
